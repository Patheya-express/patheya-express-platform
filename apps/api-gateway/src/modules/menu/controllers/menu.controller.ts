import {
  ...
  import { UpdateMenuItemDto }
  from '../dto/update-menu-item.dto';

  import {
    ToggleMenuItemAvailabilityDto,
  }
  from '../dto/toggle-menu-item-availability.dto';
  ...
  } from '../dto/create-menu-item-variant.dto';
  
  import {
    UpdateMenuItemVariantDto,
  } from '../dto/update-menu-item-variant.dto';
  ...
  import {
    UpdateAddonDto,
  } from '../dto/update-addon.dto';
  
  import {
    CreateAddonOptionDto,
  } from '../dto/create-addon-option.dto';
  
  import {
    UpdateAddonOptionDto,
  } from '../dto/update-addon-option.dto';
  import {
    ApiBearerAuth,
    ApiCreatedResponse,
    ApiOkResponse,
  ...
  } from '../dto/menu-category-response.dto';
  ...
  } from '../dto/menu-item-variant-response.dto';
  
  import {
    MenuAddonResponseDto,
  } from '../dto/menu-addon-response.dto';
  
  import {
    MenuAddonOptionResponseDto,
  } from '../dto/menu-addon-option-response.dto';
  ...
  export class MenuController {
    ...
    createAddon(
      ...
      return this.menuService.createAddon(
        menuItemId,
        dto,
      );
    }
    ...
    updateAddon(
      ...
      return this.menuService.updateAddon(
        addonId,
        dto,
      );
    }
    ...
    deleteAddon(
      ...
      return this.menuService.deleteAddon(
        addonId,
      );
    }
    ...
    createAddonOption(
      ...
      return this.menuService.createAddonOption(
        addonId,
        dto,
      );
    }
    ...
    updateAddonOption(
      ...
      return this.menuService.updateAddonOption(
        optionId,
        dto,
      );
    }
    ...
    deleteAddonOption(
      ...
      return this.menuService.deleteAddonOption(
        optionId,
      );
    }
